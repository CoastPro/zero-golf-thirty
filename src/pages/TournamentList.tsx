              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t">
                    <a
                      href={`https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(window.location.origin)}/tournament/${tournament.slug}/login`}
                    ...
                    >
                      📱 Download QR Code for Players
                    </a>
                    <p className="text-xs text-gray-500 text-center mt-1">
                      {window.location.origin}/tournament/{tournament.slug}/login
                    </p>
                  </div>
                </div>
              );
